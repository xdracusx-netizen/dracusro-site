/* ============================================================
   ...
   Files go on Cloudflare R2 at MEDIA_BASE, named after the id:
     <id>.mp4    H.264, no audio, ~6s loop, 600x600
...
const ITEMS = [
  { id:'blue-eyes-aura', name:'Blue-Eyes Aura', slot:'Aura', pod:20,
    desc:'Wings and lightning. Stays with you.' },

  { id:'underworld-set', name:'Underworld Set', slot:'Aura', pod:24,
    desc:'Violet smoke and a slow spiral at the feet.' },

  // Add the next one here. Only `id` has to match the filenames in R2.
